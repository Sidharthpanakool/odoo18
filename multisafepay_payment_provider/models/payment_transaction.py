...
class PaymentTransaction(models.Model):
    ...
    #     # when only one payment method is enabled on multisafepay and query parameters are provided.
    ...
    #         )],
    #         # Since multisafepay does not provide the transaction reference when returning from
